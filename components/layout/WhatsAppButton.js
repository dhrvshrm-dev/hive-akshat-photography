...
export default function WhatsAppButton() {
  ...
  return (
    ...
    <a
      ...
      data-cursor="Chat"
      className="relative flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/40 transition-transform hover:scale-105"
    >
